...
from data_grl import TextMelSpeakerDataset, TextMelSpeakerBatchCollate, TextMelSpeakerAccentDataset, TextMelSpeakerAccentBatchCollate
...
log_dir = '/data2/xintong/gradtts/logs/joycent_e4'
...
def run(rank, n_gpus):
    ...
    model = GradTTSConformerGSTWhisper3Qwen2facodec3accrmllm(nsymbols, n_spks, spk_emb_dim, n_enc_channels,
                    ...
                    acc_cln_layer=0, spk_cln_layer=3, spk_dec=True, acc_dec=True).cuda(rank)
