...
from joycent.model.text_encoder_conformeroriconv import TextEncoder, TextConformerEncoder
...
class GradTTSConformerORIConv(BaseModule):
    def __init__(self, n_vocab, n_spks, spk_emb_dim, n_enc_channels, filter_channels, filter_channels_dp, 
        ...
        super(GradTTSConformerORIConv, self).__init__()
