...
from joycent.model.text_encoder_conformerori import TextEncoder, TextConformerEncoder
...
class GradTTSConformerORIGST(BaseModule):
    def __init__(self, n_vocab, n_spks, spk_emb_dim, n_enc_channels, filter_channels, filter_channels_dp, 
        ...
        super(GradTTSConformerORIGST, self).__init__()
