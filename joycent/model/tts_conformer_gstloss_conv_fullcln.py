...
from joycent.model.text_encoder_conformerconv import TextEncoder, TextConformerEncoderFullCLN
...
from joycent.model.module_gstloss import GST
from joycent.model.classifier import GradientReversalFunction
from torch.nn import functional as F
from copy import deepcopy

class GradTTSConformerConvGSTFullCLN(BaseModule):
    def __init__(self, n_vocab, n_spks, spk_emb_dim, n_enc_channels, filter_channels, filter_channels_dp, 
        ...
        super(GradTTSConformerConvGSTFullCLN, self).__init__()
        ...
        self.encoder = TextConformerEncoderFullCLN(n_vocab, n_feats, n_enc_channels, 
                                   filter_channels, filter_channels_dp, n_heads, 
