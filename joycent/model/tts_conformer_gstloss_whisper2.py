...
from joycent.model.module_gstloss_grl_whisper2 import GSTWhisper
from joycent.model.classifier import GradientReversalFunction
from torch.nn import functional as F
from copy import deepcopy

class GradTTSConformerGSTWhisper2(BaseModule):
    def __init__(self, n_vocab, n_spks, spk_emb_dim, n_enc_channels, filter_channels, filter_channels_dp, 
        ...
        super(GradTTSConformerGSTWhisper2, self).__init__()
    ...
    def compute_loss(self, x, x_lengths, y_prompt, y, y_lengths, cond=None, spk=None, acc=None, out_size=None):
        ...
        # print("train. embedded_gst.shape", embedded_gst.shape, "spk.shape", spk.shape, "x.shape", x.shape)
        ...
        if self.grl:
            ...
            return dur_loss, prior_loss, diff_loss, loss_acc, loss_spk