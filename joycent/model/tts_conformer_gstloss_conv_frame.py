...
from joycent.model.text_encoder_conformerconv import TextEncoder, TextConformerEncoder
...
class GradTTSConformerConvGSTFrame(BaseModule):
    def __init__(self, n_vocab, n_spks, spk_emb_dim, n_enc_channels, filter_channels, filter_channels_dp, 
        ...
        super(GradTTSConformerConvGSTFrame, self).__init__()
    ...
    def compute_loss(self, x, x_lengths, y, y_lengths, cond=None, spk=None, acc=None, out_size=None):
        ...
        mu_x, logw, x_mask = self.encoder(x, x_lengths, spk, acc, cond=None)
